...
SNAPSHOT=false;
snapshot_time=1000:100:4000; %on what steps
...
% mask_mx=[0 0 0 0 1.d0 0 0 0 0;...         %u
%            0 1.d0 0 0 0 0 0 1.d0 0;...     %ux
%            0 0 0 1.d0 0 1.d0 0 0 0;...     %uy
%            0 1.d0 0 0 1.d0 0 0 1.d0 0;...  %uxx
%            0 0 0 1.d0 1.d0 1.d0 0 0 0;...  %uyy
%            1.d0 0 1.d0 0 0 0 1.d0 0 1.d0];%uxyassembly

mask_mx = ones(size(tmp_coeff));
tic;
for i=2:NX %over OX
    for j=2:NY %over OY
         cux=[1.d0; 1.d0; 1.d0; C(i,j,1); C(i,j,4); C(i,j,2)];
         cuy=[1.d0; 1.d0; 1.d0; C(i,j,4); C(i,j,3); C(i,j,4)];
...
%                             [A0,B0,A1,B1]=A0B0A1B1triso2(i,j,ik,jk,0,0,nvx,nvy,C,rho,dx,dy, ik*eta0x,-ik*eta1x, jk*eta0y, -jk*eta1y); % + 
            ...
            coeffux{i,j} = bsxfun(@times,cux,coeffux{i,j}).*mask_mx;
            coeffuy{i,j} = bsxfun(@times,cuy,coeffuy{i,j}).*mask_mx;            
