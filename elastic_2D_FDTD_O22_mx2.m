...
%% TIME STEPPING
t_total = 10;                      % [sec] recording duration
...
for it = 1:nt                       
    ...
    duz_dxz = co_dzx * (uz2(3:end,1:end-2) - uz2(3:end,3:end) ...
