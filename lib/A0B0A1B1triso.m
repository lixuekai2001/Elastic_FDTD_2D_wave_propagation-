...
function [A0,B0,A1,B1] = A0B0A1B1triso(i,j,iia,jja,iib,jjb,nvx,nvy,C,rho,dx,dz,eta0x,eta1x,eta0y,eta1y)
SHOWALL=true;
...
%BC eq.4
    ...
    ye4ux_dxa = nvx*C(i+iia,j+jja,2);
    ye4ux_dya = nvy*C(i+iia,j+jja,4);
    ye4uy_dxa = nvy*C(i+iia,j+jja,4);
    ye4uy_dya = nvx*C(i+iia,j+jja,3);
    ...
    ye4ux_dxb = nvx*C(i+iib,j+jjb,2);
    ye4ux_dyb = nvy*C(i+iib,j+jjb,4);
    ye4uy_dxb = nvy*C(i+iib,j+jjb,4);
    ye4uy_dyb = nvx*C(i+iib,j+jjb,3);
...
%         clf;
    ...
    r = eta0x;
    s = eta0y;
%     A0=[1.d0 r*dx s*dz (r*dx)^2.d0/2.d0 (s*dz)^2.d0/2.d0 r*s*dx*dz 1.d0 r*dx s*dz (r*dx)^2.d0/2.d0 (s*dz)^2.d0/2.d0 r*s*dx*dz; ...
%         0 1.d0 0 r*dx 0 s*dz 0 1.d0 0 r*dx 0 s*dz; ...
%         0 0 1.d0 0 s*dz r*dx 0 0 1.d0 0 s*dz r*dx; ...
%         0 0 0 1.d0 0 0 0 0 0 1.d0 0 0; ...
%         0 0 0 0 1.d0 0 0 0 0 0 1.d0 0; ...
%         0 0 0 0 0 1.d0 0 0 0 0 0 1.d0; ...
%         1.d0 r*dx s*dz (r*dx)^2.d0/2.d0 (s*dz)^2.d0/2.d0 r*s*dx*dz 1.d0 r*dx s*dz (r*dx)^2.d0/2.d0 (s*dz)^2.d0/2.d0 r*s*dx*dz; ...
%         0 1.d0 0 r*dx 0 s*dz 0 1.d0 0 r*dx 0 s*dz; ...
%         0 0 1.d0 0 s*dz r*dx 0 0 1.d0 0 s*dz r*dx; ...
%         0 0 0 1.d0 0 0 0 0 0 1.d0 0 0; ...
%         0 0 0 0 1.d0 0 0 0 0 0 1.d0 0; ...
%         0 0 0 0 0 1.d0 0 0 0 0 0 1.d0];    
%     A0=[1.d0 r*dx s*dz (r*dx)^2.d0/2.d0 (s*dz)^2.d0/2.d0 r*s*dx*dz; ...
%         0 1.d0 0 r*dx 0 s*dz; ...
%         0 0 1.d0 0 s*dz r*dx; ...
%         0 0 0 1.d0 0 0; ...
%         0 0 0 0 1.d0 0; ...
%         0 0 0 0 0 1.d0; ...
%         1.d0 r*dx s*dz (r*dx)^2.d0/2.d0 (s*dz)^2.d0/2.d0 r*s*dx*dz; ...
%         0 1.d0 0 r*dx 0 s*dz; ...
%         0 0 1.d0 0 s*dz r*dx; ...
%         0 0 0 1.d0 0 0; ...
%         0 0 0 0 1.d0 0; ...
...
%         clf;
    ...
    r = eta1x;
    s = eta1y;
%     A1=[1.d0 r*dx s*dz (r*dx)^2.d0/2.d0 (s*dz)^2.d0/2.d0 r*s*dx*dz 1.d0 r*dx s*dz (r*dx)^2.d0/2.d0 (s*dz)^2.d0/2.d0 r*s*dx*dz; ...
%         0 1.d0 0 r*dx 0 s*dz 0 1.d0 0 r*dx 0 s*dz; ...
%         0 0 1.d0 0 s*dz r*dx 0 0 1.d0 0 s*dz r*dx; ...
%         0 0 0 1.d0 0 0 0 0 0 1.d0 0 0; ...
%         0 0 0 0 1.d0 0 0 0 0 0 1.d0 0; ...
...
%         0 0 0 0 1.d0 0 0 0 0 0 1.d0 0; ...
%         0 0 0 0 0 1.d0 0 0 0 0 0 1.d0];    
%     A1=[1.d0 r*dx s*dz (r*dx)^2.d0/2.d0 (s*dz)^2.d0/2.d0 r*s*dx*dz; ...
%         0 1.d0 0 r*dx 0 s*dz; ...
%         0 0 1.d0 0 s*dz r*dx; ...
%         0 0 0 1.d0 0 0; ...
%         0 0 0 0 1.d0 0; ...
